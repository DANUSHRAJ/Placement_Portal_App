...
// const PersonalDJSON._(this.id, this.uregno,this.land, this.pmno, this.emno,this.pmail, this.amail, this.pan,
//  this.natio,this.pass, this.adhr,this.fname,this.focp,this.fmno,this.fmail,this.mname,this.mocp,this.mmno,this.mmail,
