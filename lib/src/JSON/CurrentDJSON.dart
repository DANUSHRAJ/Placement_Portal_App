 ...
 const CurrentDJSON._(this.id, this.uregno,this.gpa1,this.gpa2,this.gpa3,this.gpa4,this.gpa5,this.gpa6,this.gpa7,this.gpa8,this.ogpa,this.are1,this.are2,this.are3,this.are4,this.are5,this.are6,this.are7,this.are8,this.tare,this.areYN, this.areno);
