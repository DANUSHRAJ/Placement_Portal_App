...
import 'package:SJIT_PLACEMENT_PORTAL/src/JSON/CurrentDJSON.dart';
import '../PROFILE/ProfileData.dart';
import 'package:dio/dio.dart';
import 'package:flutter/cupertino.dart';

import '../JSON/Account.dart';
import '../JSON/EducationDJSON1.dart';
import '../JSON/ExtraDJSON.dart';
import '../JSON/GenealDJSON.dart';
import '../JSON/PersonalDJSON.dart';
import '../JSON/ExtraDJSON.dart';
...
//      log('$rescheck');
    if (rescheck == null) {
      final response = await _dio.post('/uploadPersonalD', data: {
        ...
        'AADHAAR NUMBER': adhr,
        'FATHER NAME': fname,
        'Father DESIGNATION & ORGANISATION': focp,
        'FATHER MOBILE NUMBER': fmno,
        'FATHER EMAIL ID': fmail,
        'MOTHER NAME': mname,
        'Mother DESIGNATION & ORGANISATION': mocp,
