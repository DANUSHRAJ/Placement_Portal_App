class IWCDetails {
  ...
  const IWCDetails._(this.id, this.regno, this.username, this.title, this.name, this.sd, this.ed, this.clink, this.plink, this.flink);
  ...
  factory IWCDetails.fromJson(Map json) {
    ...
    return IWCDetails._(_id, _regno, _username, _title,_name,_sd,_ed,_clink,_plink,_flink);
  }
}
